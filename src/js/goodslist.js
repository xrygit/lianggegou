$(function(){
	...
	$('#main ul li .box .pm .btn').click(function(e){		
		var goodId = $(this).parent().parent().attr("data-good-id");	
		var goodName = $(this).parent().siblings('.spname').children().html();		
		var goodPrice = parseFloat($(this).parent().siblings('.pirce').find('.q').html());	
		var goodSrc = $(this).parent().siblings('.img').children().attr("src");
	...
	$('#splist li .box .pm .sl .plus').click(function(){
		var count = parseInt($(this).prev().val());
			count +=1;
			$(this).prev().val(count);
	})
	$('#splist li .box .pm .sl .minus').click(function(){
